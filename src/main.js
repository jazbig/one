...
const phonePopup = document.querySelector('.popup');
const windowCalc = document.querySelector('.popup_calc');
const buttonCalc = document.querySelectorAll('.popup_calc_btn');
const closeCalc = document.querySelector('.popup_calc_close');
const nextCalc = document.querySelector('.popup_calc_button');
const Window2Calc = document.querySelector('.popup_calc_profile');
const Window2CalcClose = document.querySelector('.popup_calc_profile_close');
const Window3Calc = document.querySelector('.popup_calc_end');
const Window3CalcClose = document.querySelector('.popup_calc_end_close');
